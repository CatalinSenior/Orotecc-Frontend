...
const Hero = ({ title, subtitle, bannerImage, bannerAlt = "banner", bannerImageClassName = "" }: HeroProps) => (
  <section className="relative z-10 w-full h-[500px] mt-[72px] overflow-hidden">
