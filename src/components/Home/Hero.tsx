  ...
  return (
    <div className="relative w-full overflow-hidden pt-[72px]">
      <Image
        ...
        priority
      />
      <Container className="relative z-10 flex flex-col lg:flex-row items-cente lg:items-stretch mt-12 md:mt-24 lg:mt-36 justify-center min-h-[calc(100vh)] lg:min-h-[calc(100vh+150px) py-12 md:py-0 gap-6">
        {/* Left Content */}
        <div className="w-full md:w-1/2 flex flex-col items-start text-cente md:text-let">
        ...
        <div className="relative w-full md:w-1/2 h-[50vh] md:h-[calc(100vh+72px) flex items-center justify-center pointer-events-none">
          <div className="absolute w-[660px] h-[600px] scale-[0.5] sm:scale-[0.7] md:scale-[0.8] lg:scale-100">
            <div className="absolute -right-16 top-[60%] -translate-y-1/2 z-30 flex items-center justify-center" style={{ width: 660, height: 600 }}>
              <motion.div
                className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-50 size-[560px]"
                animate={{ rotate: 360 }}
              ...
              <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2  size-[400px]">
                <Image
            ...
            <Image
              ...
              width={90}
              height={90}
              className="absolute right-[460px] top-[80%] z-30"
            />
            <Image
              ...
              width={259}
              height={240}
              className="absolute right-[120px] -bottom-[50px] z-30"
            />
            <Image
              ...
              width={259}
              height={240}
              className="absolute right-[350px] top-[43%] z-30"
            />
            <Image
              src="/cloud/cloud.png"
              alt="Cloud"
              width={120}
              height={120}
              className="absolute right-[410px] top-[30%] z-30"
            />
            <Image
              ...
              width={90}
              height={90}
              className="absolute right-[80px] top-[10%] z-30"
            />
            <Image
              ...
              width={259}
              height={240}
              className="absolute -right-[100px] top-[30%] z-30"
            />
             <Image
              src="/cloud/cloud.png"
              alt="Cloud"
              width={120}
              height={120}
              className="absolute -right-[20px] top-[70%] z-30"
            />
          </div>
        </div>
      </Container>
